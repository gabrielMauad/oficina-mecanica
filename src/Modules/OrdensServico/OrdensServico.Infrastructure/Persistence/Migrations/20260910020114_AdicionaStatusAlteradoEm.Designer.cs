...
namespace OrdensServico.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910020114_AdicionaStatusAlteradoEm")]
    partial class AdicionaStatusAlteradoEm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrdensServico.Adapters.DataSources.Records.ItemPecaRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OrdensServico.Adapters.DataSources.Records.ItemServicoRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OrdensServico.Adapters.DataSources.Records.OrcamentoRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OrdensServico.Adapters.DataSources.Records.OrdemServicoRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("OrdensServico.Adapters.DataSources.Records.ItemPecaRecord", b =>
                {
                    b.HasOne("OrdensServico.Adapters.DataSources.Records.OrdemServicoRecord", null)
                        .WithMany("ItensPeca")
